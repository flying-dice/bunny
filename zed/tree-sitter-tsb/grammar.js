/**
 * tsb tree-sitter grammar — defined from scratch, not a fork.
 *
 ...
 *   - Phase 7: tsb-specific (#[…] attributes, match, Self, patterns).
 */
...
module.exports = grammar({
  ...
  rules: {
    ...
    // `Self` is a reserved type token in tsb. The bare literal
