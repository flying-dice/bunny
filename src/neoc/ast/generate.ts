/**
 * Generate `src/neoc/ast/nodes.generated.ts` from the tree-sitter
 ...
 *
 *   bun run src/neoc/ast/generate.ts
 *
...
const NODE_TYPES = resolve(HERE, "../../../zed/tree-sitter-neoc/src/node-types.json");
const OUT = resolve(HERE, "nodes.generated.ts");

const HEADER = `// AUTO-GENERATED from zed/tree-sitter-neoc/src/node-types.json.
